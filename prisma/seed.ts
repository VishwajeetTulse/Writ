 ...
 * Catalog seed.
 *
 * This is mock data and the README says so. Four merchants, sixteen SKUs, real Indian
 * products at plausible prices. It exists to give the buyer agent something honest to
 * shop, not to pretend at a real inventory.
 *
